            ...
            <nav className="wsmenu clearfix" style={{ maxHeight: "700px" }}>
              ...
              <ul className="wsmenu-list">
                ...
                <li onClick={() => activeFun("pages")}>
                  ...
                  <a href="#">
                    Mock Tests <span className="wsarrow" />
                  </a>
                  {/* <ul
                ...
                {/* END DROPDOWN MENU */}
                {/* DROPDOWN MENU */}
                <li onClick={() => activeFun("Practice")}>
                  <span className={`wsmenu-click ${iconChange("Practice")}`}>
                    <i className="wsmenu-arrow" />
                  </span>
                  <a href="#">
                    Practice <span className="wsarrow" />
                  </a>
                  <ul className={`sub-menu ${activeLi("Practice")}`}>
                    <li>
                ...
                {/* END DROPDOWN MENU */}
                {/* MEGAMENU */}
                <li onClick={() => activeFun("Study")}>
                  <span className={`wsmenu-click ${iconChange("Study")}`}>
                    <i className="wsmenu-arrow" />
                  </span>
                  <a href="#">
                    Study Material <span className="wsarrow" />
                  </a>
                  <ul className={`sub-menu ${activeLi("Study")}`}>
                    <li>
                      {/* <Link href="courses-list">Development</Link> */}
                      English
                    </li>
                ...
                {/* <li onClick={() => activeFun("Mega")}>
                  ...
                  <div className={`wsmegamenu clearfix ${activeLi("Study")}`}>
