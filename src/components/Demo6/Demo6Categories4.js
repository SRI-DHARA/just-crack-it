...
const Demo6Categories4 = () => {
    return (
        <section
            id="categories-4"
            className="wide-60 categories-section division"
        >
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB PRT</h5>
                                {/* <p>341 Courses</p> */}
                            </div>
                            {/* List */}
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB TGT</h5>
                                {/* <p>428 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB PGT</h5>
                                {/* <p>268 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB Dass Grade-II</h5>
                                {/* <p>417 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB JE SO</h5>
                                {/* <p>284 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB Junior Assistant</h5>
                                {/* <p>179 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB Junior Steno</h5>
                                {/* <p>369 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB Food Safety Officer</h5>
                                {/* <p>219 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="c4-box">
                            ...
                            <div className="c4-box-ico mb-15 clearfix">
                                ...
                                <h5 className="h5-md">DSSSB Store Keeper</h5>
                                {/* <p>370 Courses</p> */}
                            </div>
                            {/* List */}
                            {/* <div className="c4-box-txt">
...
export default Demo6Categories4;
